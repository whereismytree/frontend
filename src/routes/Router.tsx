...
import SearchLocation from 'pages/TreeRegistPage/Search';
import Redirect from 'pages/LoginPage/Redirect';
import ReviewDetailPage from 'pages/ReviewDetailPage';
import RegistMap from 'pages/TreeRegistPage/Map';
import TreeRegiDetail from 'pages/TreeRegistPage/Form';
